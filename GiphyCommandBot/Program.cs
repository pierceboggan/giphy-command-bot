using GiphyCommandBot;
using GiphyCommandBot.Commands;
...
builder.Services.AddSingleton<GiphyCommandHandler>();
builder.Services.AddSingleton(sp =>
{
    var options = new ConversationOptions()
    {
        ...
        {
            Commands = new List<ITeamsCommandHandler> { sp.GetService<GiphyCommandHandler>() }
        }
    };
